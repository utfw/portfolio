// Direction A — Engineer-first (v2)
// Mood: terminal-adjacent, monospace-led, technical, dense.
// Layout: left sidebar (nav + meta) / center body / right sidepanel + footnotes / bottom footer.
...
function DirectionA({ data, density = "comfortable", bodyType = "mono", accent = "#9b3a2a" }) {
